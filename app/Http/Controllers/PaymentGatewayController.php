...
class PaymentGatewayController extends Controller
{
    ...
    public function getToken(){
       try{
        $client = new Client();
        $response = $client->request('POST', 'https://halalmoneytransfer.com/pay/sandbox/api/v1/authentication/token', [
            'json' => [
    ...
    public function initiatePayment(Request $request){
        ...
        try{
            ...
            $response = $client->request('POST', 'https://halalmoneytransfer.com/pay/sandbox/api/v1/payment/create', [
                'json' => [
