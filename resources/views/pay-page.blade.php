...
<head>
    ...
    <title>{{ __("HMT - Money Transfer with QR Code") }}</title>
    ...
    <!-- favicon -->
    <link rel="shortcut icon" href="{{ asset('public/HMT/fav.png') }}" type="image/x-icon">
    <!-- bootstrap css link -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('public/HMT/css/style.css') }}">
                ...
                <div class="col-lg-5">
                    <form class="demo-payment-form" method="POST" action="{{ route('pay.initiate.payment') }}">
                        ...
                        <div class="badge-area mt-20 text-center">
                            <span class="form-text powered-badge"><i class="fas fa-bolt"></i> {{ __("Powered by HMT") }}</span>
                        </div>
                    </form>
                </div>
            </div>
...
<!-- bootstrap js -->
<!-- jquery -->
<script src="{{ asset('public/HMT/') }}/js/jquery-3.5.1.min.js"></script>
